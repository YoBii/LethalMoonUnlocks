...
namespace LethalMoonUnlocks {
    public class ConfigManager {
        ...
        private static void RefreshValues() {
            ...
            TerminalScrollAmount = GetConfigValue("6.3 - Terminal", "Terminal scroll amount", 3, "Override the Terminal's moon catalogue scroll amount. Lines per scroll action. 0 to disable\n" +
